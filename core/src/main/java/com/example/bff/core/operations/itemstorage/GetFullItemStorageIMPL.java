...
import com.example.bff.core.operations.exceptions.ResourceNotFoundException;
...
public class GetFullItemStorageIMPL implements GetFullItemStorageOperation {
    ...
    public GetFullItemStorageResponse process(GetFullItemStorageRequest storageItem) {
        ...
        try {
            getItemStorageResponse = storageServiceRestClient.getItemStorage(
                    storageItem.getItemStorageId().toString());
            getItemResponse = zooStoreRestClient.getItemById(
                    getItemStorageResponse.getItemId().toString());
        }
        catch (Exception e) {
